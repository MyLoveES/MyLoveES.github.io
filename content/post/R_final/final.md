...
![](1_hierarchical_segmetation_clust_complete.png)

```
> plot(cut(as.dendrogram(seg.hc), h = 4)$lower[[1]])
```

![](1_hierarchical_segmetation_clust_cut.png)
...
![](1_hierarchical_segmetation_clust_rect_k_plot.png)
...
![](1_hierarchical_segmetation_clust_k_4_plot.png)
...
![](1_hierarchical_segmetation_clust_boxplot_salary.png)

```
> boxplot(seg.df$Employment ~ seg.hc.segment, ylab = "Employment", xlab = "Cluster")
```

![](1_hierarchical_segmetation_clust_boxplot_emplyment.png)
...
![](1_hierarchical_segmetation_kmeans_boxplot_emplyment.png)

```
> boxplot(seg.df$Education ~ seg.k$cluster, ylab = "Education", xlab = "Cluster")
```

![](1_hierarchical_segmetation_kmeans_boxplot_education.png)
...
![](1_hierarchical_segmetation_mclust_clusplot.png)

```
boxplot(seg.df$Education ~ seg.mc$classification, ylab = "Education", xlab = "Cluster")
```

![](1_hierarchical_segmetation_mclust_boxplot_education.png)

```
boxplot(seg.df$Employment ~ seg.mc$classification, ylab = "Employment", xlab = "Cluster")
```

![](1_hierarchical_segmetation_mclust_boxplot_employment.png)
