...
# brand.ratings <- subset(brand.ratings, select = -c(product_id,company_location,review_date,country_of_bean_origin,cocoa_percent,counts_of_ingredients,cocoa_butter,first_taste,second_taste,third_taste))
